...
> 
> **重要**：必须订阅 `im.message.receive_v1` 事件，否则机器人无法接收消息！
...
| 接收群聊中@机器人消息事件 | `im:message.group_at_msg:readonly` | **群聊 @ 机器人必需**，缺少此权限群聊消息不会推送 |
| 获取与发送群组消息 | `im:message.group_msg` | **获取群聊历史消息必需**（上下文功能需要） |
